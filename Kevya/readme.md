...
```shell
msbot clone services --name "Kevya" --luisAuthoringKey "YOUR_AUTHORING_KEY" --folder "DeploymentScripts\YOUR_LOCALE_FOLDER" --location "westus"
```
...
```shell
az bot publish --name "Kevya" --resource-group "Kevya"
```
